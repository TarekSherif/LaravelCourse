...
<input type="hidden" name="id" value="{{$test->id}}">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input  type="text" class="form-control{{ $errors->has('Tname') ? ' is-invalid' : '' }}" name="Tname" value="{{ old('Tname',$test->Tname) }}" >
                                @if ($errors->has('Tname'))
             ...
             <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input  type="text" class="form-control{{ $errors->has('Tphone') ? ' is-invalid' : '' }}" name="Tphone" value="{{ old('Tphone',$test->Tphone) }}" >
